...
export default function TeacherDashboardPage() {
  ...
  const homeActive = pathname === '/teacher/dashboard';
  const classesActive = pathname.startsWith('/teacher/classes');
  const studentsActive = pathname.startsWith('/teacher/students');
        ...
        <aside className="fixed left-0 top-0 z-40 flex h-screen w-72 flex-col bg-[#243b55] text-white shadow-2xl">
          <div className="px-6 py-6 border-b border-white/10">
            <div className="flex items-center gap-4">
              ...
              />
              <div>
                <h1 className="text-lg font-bold leading-tight">SCMS Teacher</h1>
              </div>
            </div>
          </div>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <div className="rounded-3xl bg-white p-6 shadow-xl ring-1 ring-[#e6edf6]">
                ...
                <p className="mt-3 text-sm text-gray-600">
                  Manage classes, monitor students, and access teaching tools.
                </p>
